...
export default function Works() {
  ...
  return (
    <div
      className="relative scroll-mt-24 sm:scroll-mt-28 rounded-xl border-3 border-black bg-bg-panel p-8 max-sm:p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] min-h-[340px]"
      id="works"
    >
