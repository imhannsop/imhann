...
export default function Skills() {
  return (
    <div className="relative scroll-mt-3 md:scroll-mt-20 rounded-xl border-3 border-black bg-bg-panel p-8 max-sm:p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]" id="skills">
